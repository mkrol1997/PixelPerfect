...
SECRET_KEY = 'django-insecure-+c_n4*bd=u^x2rak!0y_kne79+zs-y_==v7at=h=or&%j-e!je'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, "celery_test/templates"), os.path.join(BASE_DIR, "celery_imp/templates")],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
