...
MODELS_STORAGE = {
    ...
    "color": os.path.join(settings.BASE_DIR.parent, "image_processing/models/enhance/fbcnn_color.pth"),
    "color_real": os.path.join(settings.BASE_DIR.parent, "image_processing/models/enhance/fbcnn_color.pth"),
    "greyscale": os.path.join(settings.BASE_DIR.parent, "image_processing/models/enhance/fbcnn_gray.pth"),
}
